  ...
  if(!is_login){
    return(
      <Grid margin="100px 0px" padding="16px" center>
        <Text size="32px" bold>앗!</Text>
        <Text size="16px">로그인 후에만 글을 쓸 수 있어요!</Text>
        <Button _onClick={()=>{history.replaceState("/")}}>로그인 하러가기</Button>
      </Grid>
    )
  }
  return (
      <React.Fragment>
        ...
        <Grid padding="16px">
          <Button _onClick={addPost} style={{position: "absolute", left:"40%"}} width="50%" padding="10px">작성</Button>
        </Grid>
      </React.Fragment>
    );
}
